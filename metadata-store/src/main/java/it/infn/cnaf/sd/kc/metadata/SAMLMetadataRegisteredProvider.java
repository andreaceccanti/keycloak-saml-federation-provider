...
public class SAMLMetadataRegisteredProvider {

  private final String providerKey;
  private final String metadataUrl;

  private SAMLMetadataRegisteredProvider(Builder b) {
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    SAMLMetadataRegisteredProvider other = (SAMLMetadataRegisteredProvider) obj;
    if (providerKey == null) {
  ...
  public static class Builder {
    ...
    public SAMLMetadataRegisteredProvider build() {
      return new SAMLMetadataRegisteredProvider(this);
    }
  }
}
