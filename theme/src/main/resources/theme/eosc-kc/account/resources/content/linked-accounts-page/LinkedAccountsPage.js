...
class LinkedAccountsPage extends React.Component {
  ...
  getLinkedAccounts() {
    this.context.doGet("/../saml-aggregate-broker/linked-accounts").then(response => {
      console.log({
        response
      });
  ...
  unLinkAccount(account) {
    const url = '/../saml-aggregate-broker/linked-accounts';
    const requestOptions = {
        method: 'DELETE',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(account)
    };
    this.context.doRequest(url, requestOptions).then(response => {
      console.log({
        response
      });
      this.getLinkedAccounts();
  ...
  linkAccount(account) {
    const url = '/../saml-aggregate-broker/linked-accounts/' + account.providerName;
  ...
  makeRows(accounts, isLinked) {
    ...
    return React.createElement(React.Fragment, null, " ", accounts.map(account => React.createElement(DataListItem, {
      ...
      dataListCells: [React.createElement(DataListCell, {
        ...
        isFilled: true
      }, React.createElement("h2", null, React.createElement("strong", null, this.formatProvider(account)))))), React.createElement(DataListCell, {
        key: "badge"
      }, React.createElement(Stack, null, React.createElement(StackItem, {
        isFilled: true
      }), React.createElement(StackItem, {
  ...
  formatProvider(account) {
    if (account.samlaggregate) {
      return account.entityId + "@" + account.providerAlias;
    }
    return account.providerAlias
  }
  ...
  badge(account) {
    ...
    if (account.samlaggregate) {
      return React.createElement(Badge, { style: { backgroundColor: "red" } }, React.createElement(Msg, {
        msgKey: "saml aggregate"
      }));
    }
